...
#ifndef UNIVERSAL_TERRAIN_LIT_SEGSHAODW_PASSES_INCLUDED
#define UNIVERSAL_TERRAIN_LIT_SEGSHAODW_PASSES_INCLUDED
...
#endif
{
	...
	//add by zyb for segments shadow
	half3 segmentsShadow = SegShadowLoop(inputData.positionWS);
	color.rgb *= segmentsShadow;
